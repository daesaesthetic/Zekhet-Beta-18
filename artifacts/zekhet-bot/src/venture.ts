...
export const ventureEncounters: VentureEncounter[] = [
  {
    ...
    rarity: "COMMON",
    outcome: "You recover a few coins and leave the shrine undisturbed.",
    reward: { currency: 18, xp: 8 },
  ...
  },
  {
    ...
    rarity: "COMMON",
    outcome: "The map is yours. Its ink may be more useful than its missing courier.",
    reward: { currency: 27, xp: 12 },
  ...
  },
  {
    ...
    rarity: "UNCOMMON",
    outcome: "You uncover a modest purse and a note that reads: 'Acceptable handwriting.'",
    reward: { currency: 48, xp: 22 },
  ...
  },
  {
    ...
    rarity: "RARE",
    outcome: "The chest contains a careful reserve of Deben and a receipt for goods never delivered.",
    reward: { currency: 112, xp: 58 },
    location: "🏜️ Glass Desert",
    successful: true,
  },
  {
    ...
    rarity: "RARE",
    outcome: "A forgotten court left a generous offering for whoever noticed the impossible door.",
    reward: { currency: 86, xp: 72 },
    location: "🏛️ Hall of the Court",
    successful: true,
  },
  {
    ...
    rarity: "EPIC",
    outcome: "You return with a purse from a forgotten archivist and a memory that is not entirely yours.",
    reward: { currency: 214, xp: 118 },
    location: "📜 Grand Archives",
    successful: true,
  },
  {
